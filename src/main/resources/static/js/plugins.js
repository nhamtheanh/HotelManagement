...
// Khi admin nhấn vào button chat, chuyển hướng đến trang respond-support.html
function redirectToChat() {
    window.location.href = "/admin/respond-support"; // Đúng với đường dẫn trong controller
}

// Khi user nhấn vào button chat, chuyển hướng đến trang request-support.html
function customerToChat() {
    window.location.href = "/customer/request-support"; // Đúng với đường dẫn trong controller
}
